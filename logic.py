...
bank_deck = BankDeck()
working_deck = WorkingDeck(bank_deck.get_bank_deck())  # bank_deck.get_bank_deck())
...
bank_deck.print_bank_deck_words()
for x in range(4):
    working_deck.pick_word_in_bank_deck()
    working_deck.print_working_deck_words()
    bank_deck.print_bank_deck_words()

print(working_deck.get_working_deck())
